...
- **Current Sprint 05 work:** Item 6 is in progress. `/payroll` provides the initial Accountant workspace; it still needs service-backed previews, salary-definition forms, and audit-history presentation before handoff as complete.

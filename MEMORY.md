...
- **Active work (2026-09-07):** Sprint 12 item 2a is in progress for the explicitly requested user-profile display name and payout bank branch-name/account-type fields, plus a shared icon colour refinement. See `sprints/12-standard-mcp-and-api.md`.

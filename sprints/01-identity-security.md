...
| 4b | In progress | 2026-09-03 | Development test harness: use an explicitly configured EF Core in-memory database, seed representative cross-domain data, and provide a Development-only role-selectable login bypass. Acceptance: unavailable outside Development; tests prove seeded roles and authorization behavior. |
| 5 | Not started | — | — |
| 6 | Not started | — | — |
| 7 | Not started | — | — |
| 8 | Not started | — | — |

...
| 2c | In progress | 2026-09-07 | User-requested collection-entry follow-up: place payment method beside client; allow custom purpose/amount inputs with client-scoped suggestions while retaining matched option links; submit browser-local payment date/time as UTC. Requires a transaction snapshot/schema change, service validation, MVC form conversion, and tests. |
| 3 | Not started | — | — |
| 4 | Not started | — | — |
| 5 | Not started | — | — |
| 6 | Not started | — | — |

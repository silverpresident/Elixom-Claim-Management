...
| 5 | Blocked | 2026-09-03 | The required Accountant-scoped MCP preview/run trigger cannot be implemented safely: `ElixomClaim.Web/Mcp/Tools` and MCP transport/operation infrastructure do not yet exist and are Sprint 06 scope. Add the narrowly scoped MCP payroll-operation prerequisite before resuming this item; then implement the hosted scheduler and MVC Generate Now adapter over `ISalaryPayrollService`. |
| 6 | Not started | — | — |
| 7 | Not started | — | — |

...
| 6 | In progress | 2026-09-03 | Added `/payroll` Accountant workspace showing current salary definitions and recent payroll status, with Generate Now and Submit actions. Remaining: service-backed calculation preview, definition management forms, and audit-history display. Verified `dotnet build src/ElixomClaim.Web/ElixomClaim.Web.csproj --no-restore` (success). |
| 7 | Not started | — | — |

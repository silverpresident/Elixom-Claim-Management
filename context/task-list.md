...
- [x] Add a SequenceNo field to the following entites and where a display term is needed use it instead of the GUID id:
  - Claim
  - ClaimComment
  - JobPayment 
  - CollectionClient
...
- [x] Add mock data for CollectionTransaction when db is seeded and with each dev run.
- [x] Make this CollectionTransaction print out look more like a tradiaitonal receipt and include the displayName of the teller. Display the payment date and time in local time.

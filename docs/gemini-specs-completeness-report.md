...
| Audit logging | Implemented | [`AuditService.cs`](../src/ElixomClaim.Lib/Services/AuditService.cs) stores append-only `AuditRecords`; [`20260908033045_AddAuditRecordAppendOnlyTrigger.cs`](../src/ElixomClaim.Lib/Migrations/20260908033045_AddAuditRecordAppendOnlyTrigger.cs) protects persistence. |
